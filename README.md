...
Thank you for considering contributing to the Laravel Toon Converter! The contribution guide can be found in the [CONTRIBUTING.md](https://github.com/jobmetric/laravel-toon/blob/master/CONTRIBUTING.md).

## License

The MIT License (MIT). Please see [License File](https://github.com/jobmetric/laravel-toon/blob/master/LICENCE.md) for more information.
